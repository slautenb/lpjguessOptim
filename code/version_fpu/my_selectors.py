...
def tournament_selection_constraints(random, population, args):
    """Return a tournament sampling of individuals from the population.
    ...
    for _ in xrange(num_selected):
        ...
        # a different approach would be to check how many are <=
        # and select one by chance
        # but since the order in the random sample
        # is by chance and for ties the first is
        # selected this should be fine
